...
void sha256(const uint8_t *data, size_t len, uint8_t hash[32]) {
    ...
    uint64_t bitlen = total_len * 8 + len * 8;
    buffer[63] = bitlen; buffer[62] = bitlen >> 8; buffer[61] = bitlen >> 16;
    buffer[60] = bitlen >> 24; buffer[59] = bitlen >> 32; buffer[58] = bitlen >> 40;
    buffer[57] = bitlen >> 48; buffer[56] = bitlen >> 56;
    sha256_transform(state, buffer);
    for (i = 0; i < 4; ++i) {
...
int main() {
    char password[] = "Parsa@8393";
    char salt[] = "N5SbYuuk0qx94HYr";
    char combined[256];
    ...
    printf("Stored hash:   a3b5547dd9f395f53191ad99207d3e68c1a5cd4580b0f0b049ceaa0f193d0752\n");
    return 0;
}